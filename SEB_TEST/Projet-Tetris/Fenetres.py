...
def Fen_Main_Tkinter():
    try:
        ...
        #Bouton_Algo=tkinter.Button(Fen_Princip, text="ALGO", width= 10, command=lambda:[Lst_Fct.Algo_Game(Fen_Princip, Fen_canvas)])
        ...
        ## Lancement de l'Algo ##
        Fen_Princip.after(1000,Lst_Fct.Algo_Game,Fen_Princip, Fen_canvas)
