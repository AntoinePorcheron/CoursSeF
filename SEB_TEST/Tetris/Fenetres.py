...
# SEF : du 12-01-2022 au 10-02-2022
def Fen_Main_Tkinter():
    try:
        ...
        Fen_Princip.geometry(str(Global.X_FEN) + "x" + str(Global.Y_FEN) + "+10+10")
        Fen_Princip.minsize(Global.X_FEN, Global.Y_FEN)
        ...
        Bouton_Start=tkinter.Button(Fen_Princip, text="START", width= 10, command=lambda:[Lst_Fct.Start_Game(), Fen_Princip.text.set("Mode_Jeux : " + Global.Jeux_En_Cours)])
        ...
        ## Ajout d'un bouton ALGO ## pour le lancer à la main
        #Bouton_Algo=tkinter.Button(Fen_Princip, text="ALGO", width= 10, command=lambda:[Lst_Fct.Algo_Game(Fen_Princip)])
        #Bouton_Algo.place(x=Global.X_TAB*Global.Taille_Case+50,y=150)
        ...
        Fen_Princip.bind("<Right>",Lst_Fct.Deplacer_D)
        Fen_Princip.bind("<s>",Lst_Fct.Pivoter_G)
        Fen_Princip.bind("<f>",Lst_Fct.Pivoter_D)
        Fen_Princip.bind("<Down>",Lst_Fct.Descendre_B)

        ## Lancement de l'Algo ##
        Fen_Princip.after(1000,Lst_Fct.Algo_Game,Fen_Princip)
